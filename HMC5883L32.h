...
#ifndef _HMC5883L32_h
#define _HMC5883L32_h
...
class HMC5883L32 : public I2C32
{
 protected:

	
	 sensor_vect * MagAccNormalized;

 public:
	 sensor_int_vect   MagRaw;
	 float    MagHeadingCompensated;
	 float    MagHeading;
	 sensor_orientation_t MagOrientation;
	 HMC5883L32( sensor_vect * accNormalized);
	 void setConfig();
	void init();
